...
#define PARM_TRANSISTOR_TYPE  LVT // NVT // transistor type, HVT, NVT, or LVT
#define PARM_Vdd              1.2 // 1.0
#define PARM_Freq             2.0e9 // 0.746e9
...
/* general parameters */
#define PARM_in_port        4 // 3 /* # of router input ports */
#define PARM_cache_in_port  1 // 0 /* # of cache input ports */
#define PARM_mc_in_port     0   /* # of memory controller input ports */
#define PARM_io_in_port     0   /* # of I/O device input ports */
#define PARM_out_port       4 // 3
#define PARM_cache_out_port 1 // 0  /* # of cache output ports */
#define PARM_mc_out_port    0   /* # of memory controller output ports */
#define PARM_io_out_port    0   /* # of I/O device output ports */
#define PARM_flit_width     64 // 16 /* flit width in bits */

/* virtual channel parameters */
#define PARM_v_class        0   /* # of total message classes */
#define PARM_v_channel      4 // 7 /* # of virtual channels per virtual message class*/
...
/* crossbar parameters */
#define PARM_crossbar_model     MATRIX_CROSSBAR /* crossbar model type MATRIX_CROSSBAR, MULTREE_CROSSBAR, or TRISTATE_CROSSBAR (only for Orion3.0)*/ 
...
/* HACK HACK HACK */
#define PARM_exp_xb_model   MATRIX_CROSSBAR // SIM_NO_MODEL   /* the other parameter is MATRIX_CROSSBAR */
#define PARM_exp_in_seg     2
#define PARM_exp_out_seg    2

/* input buffer parameters */
#define PARM_in_buf         1    // have input buffer? 
#define PARM_in_buf_set     16   // 64; read mainpage.h
...
#define PARM_cache_in_buf_set   16 // 64;
...
#define PARM_out_buf            1    // have output buffer? 
#define PARM_out_buf_set        16   // 64; read mainpage.h
#define PARM_out_buf_wport      1    // # of write ports 
